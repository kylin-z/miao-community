    ...
    Snow.prototype.init = function (element) {
        ...
        for (var i = 0; i < this.flakeCount; i++) {
            var x = Math.floor(Math.random() * this.canvas.width),
                ...
                size = Math.floor(100 * Math.random()) % this.settings.size + 5,
        ...
        flake.size = Math.floor(100 * Math.random()) % this.settings.size + 5, flake.speed = Math.floor(100 * Math.random()) % this.settings.speed + Math.random() * flake.size / 10 + .5, flake.velY = flake.speed, flake.velX = 0, flake.opacity = .5 * Math.random() + this.settings.opacity
    };
